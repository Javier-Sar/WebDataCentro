<%-- 
    Document   : Detalle_Visita_Transcurso
    Created on : 5 oct 2022, 13:27:36
    Author     : javie
--%>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <textarea name="Comen" rows="10" cols="40" placeholder="Comentario sobre lo realizado" required=" "></textarea>
                    ...
                    <div class="modal-footer">
                        <div class="d-grid gap-2 container-fluid">
                            ...
                            <button type="submit" class="btn btn-danger btn-block" name="accion" value="16">FINALIZAR</button>
