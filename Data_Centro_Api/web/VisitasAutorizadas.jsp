<%-- 
    Document   : VisitasAutorizadas
    Created on : 4 oct 2022, 14:20:57
    Author     : javie
--%>
...
<html>
    ...
    <body>
        <div class="container text-center">
            <h1 class="display-4"><b>LISTADO AUTORIZADO</b></h1>
        </div>
        <br>
        <br>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 container-fluid">
                            ...
                            <a type="button" class="btn btn-warning btn-block" href="Sev_Procesamiento?accion=3&Sol=${v.getID_SOLICITUD()}">VER DETALLES</a>
