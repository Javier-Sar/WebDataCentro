<%-- 
    Document   : Detalle_Visita_Oper
    Created on : 5 oct 2022, 9:10:10
    Author     : javie
--%>
...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-success">AUTORIZADA</a>
                    </div>
        ...
        <div class="d-grid gap-2 container">
            ...
            <a type="submit" class="btn btn-success btn-block" href="Sev_Procesamiento?accion=4&Sol=${s.getID_SOLICITUD()}">INICIAR VISITA</a>
            <a type="submit" class="btn btn-danger btn-block" href="Dashboard.jsp">REGRESAR A MENU</a>
